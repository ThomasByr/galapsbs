...
abstract class ClockFx with ChangeNotifier {
  ...
  /// The area from which to spawn new particles.
  late Rect spawnArea;
  ...
  ClockFx({
    ...
    this.numParticles = 5000, //! this number is king of huge
  }) {
    setTime(time);
  ...
  void setPalette(Palette palette) {
    ...
    particles
        .where((p) => p != null)
        .forEach((p) => p!.color = p.type == ParticleType.noise ? Rnd.getItem(colors) : accentColor);
  }
